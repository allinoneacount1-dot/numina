        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="border border-line/50 bg-surface-700 p-6">
              ...
              <p className="font-[family-name:var(--font-body)] text-xs text-text-mid mb-6">
                Stake $LMN to earn energy for invoking and controlling your Numina. Higher stake = more energy = more agents.
              </p>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="pt-6">
                  <span className="font-[family-name:var(--font-mono)] text-xs text-text-low">$LMN</span>
                </div>
              </div>
            ...
            <div className="border border-line/50 bg-surface-700 p-6">
              ...
              <div className="space-y-3">
                {energyRules.map((rule) => (
                  <div key={rule.action} className="flex items-center justify-between py-2 border-b border-line/20 last:border-0">
                    <span className="font-[family-name:var(--font-mono)] text-[11px] text-text-mid">
                      {rule.action}
                    </span>
                    <span className="font-[family-name:var(--font-mono)] text-[11px] text-aether-500">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="border border-line/50 bg-surface-700 p-4">
              <h3 className="font-[family-name:var(--font-mono)] text-[10px] text-text-low uppercase tracking-wider mb-4">
                Your Stakes
              </h3>
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2 border-b border-line/20">
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-text-mid">Staked</span>
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-gold-500">12,500 $LMN</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-line/20">
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-text-mid">Earned</span>
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-plasma-400">+1,247 $LMN</span>
                </div>
                <div className="flex items-center justify-between py-2">
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-text-mid">Lock</span>
                  <span className="font-[family-name:var(--font-mono)] text-[11px] text-text-hi">None</span>
                </div>
              </div>
            </div>
          </div>
